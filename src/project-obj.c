...
static void project_object_handler_MON_POIS(project_object_handler_context_t *context)
{
}
...
static void project_object_handler_VAMPIRE(project_object_handler_context_t *context)
{
}
...
static void project_object_handler_TERRAIN_FEAT(project_object_handler_context_t *context)
{
}

static void project_object_handler_HYPNOTIZE(project_object_handler_context_t *context)
{
}
