...
static borg_spell_rating borg_spell_ratings_PRIEST[] =
{
    ...
    { "Spear of Orom\xC3\xab", 85, SPEAR_OF_OROME }, /* "Spear of Orom�" */
    { "Light of Manw\xC3\xab", 85, LIGHT_OF_MANWE } /* "Light of Manw�"*/
};
 ...
 */
static void borg_init_spell(borg_magic *splls, int spell_num)
{
    borg_magic               *spell  = &splls[spell_num];
    const struct class_spell *cspell = spell_by_index(player, spell_num);
