...
MFLAG(SPOTTED,	"Monster has been spotted by the player")
...
MFLAG(CHECK_EQ, "Monster should consider equipping items")
MFLAG(TALKING,	"Monster is talking with the player")
MFLAG(KNOWN,	"Player has seen this monster before")
MFLAG(SAW_SCARY,	"Saw something scary recently")
MFLAG(UPDATE_STATE,	"Monster state should be updated")
MFLAG(UPDATE_ATTACKS,	"Monster attacks need updating")
