...
PP(BACKSTAB,				"Backstabbing",		PP_SCALE_SQRT,		100,	10,		PU_BONUS)
PP(RUNNING,					"Running",			PP_SCALE_SQRT,		100,	5,		PU_BONUS)
PP(DUAL_WIELD,				"Dual-Wielding",	PP_SCALE_LINEAR,	100,	5,		PU_BONUS)
PP(ANTIMAGIC,				"Antimagic",		PP_SCALE_SQRT,		200,	3,		PU_BONUS | PU_MANA)
PP(SPELL_POWER,				"Spellpower",		PP_SCALE_LINEAR,	150,	3,		0)
PP(SPELL_EASE,				"Spell Ease",		PP_SCALE_LINEAR,	150,	3,		0)
PP(WHIRLWIND,				"Whirlwind Attack",	PP_SCALE_SQRT,		200,	5,		0)
PP(CRITICAL_HITS,			"Critical Hits",	PP_SCALE_LINEAR,	150,	5,		PU_BONUS)
