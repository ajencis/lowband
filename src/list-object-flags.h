...
OF(POWER_LEARN_1, "Study")
OF(POWER_LEARN_2, "Study")
OF(POWER_LEARN_3, "Study")
OF(POWER_LEARN_4, "Study")
OF(POWER_LEARN_5, "Study")
OF(REALM_LEARN, "Study")
OF(PASS_WEB, "NoWeb")
OF(INVISIBILITY, "Invis")
OF(MAX, "")
