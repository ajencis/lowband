...
EFFECT(CRUNCH,						false,	NULL,		0,		EFINFO_NONE,	"crunches",	"crunch")
...
EFFECT(TERRAIN_FEAT,				true,	"amt",		0,		EFINFO_FEAT,	"produces a %s", "make %s")
EFFECT(FEAT_GROW,                   false,  "rad",      0,      EFINFO_FEAT,    "produces %ss", "make %s")
...
EFFECT(POLY_SELF,                   false,  "dur",      0,      EFINFO_RACE,    "polymorphs user into %s %s", "poly self")
EFFECT(UNPOLY_SELF,                 false,  NULL,       0,      EFINFO_NONE,    "returns user to original race", "unpoly self")
...
EFFECT(CREATE_ILLUSORY_WALL,		true,	NULL,		0,		EFINFO_NONE,	"creates an illusory wall",	"create illusory wall")
EFFECT(ECHOLOCATE,					false,	NULL,		0,		EFINFO_NONE,	"reveals surroundings",	"reveal surroundings")
EFFECT(REBIRTH,						false,	"dam",		0,		EFINFO_NONE,	"resurrects",		"resurrect")
EFFECT(TRANSFORM,					false,	NULL,		0,		EFINFO_RACE,	"transforms you into %s %s", "transform")
EFFECT(LICH_TRANSFORM,				false,	NULL,		0,		EFINFO_NONE,	"transforms you into a lich", "descend")
