...
RSF(BR_HOLY_FIRE,	RST_BREATH | RST_INNATE)
RSF(BR_HELLFIRE,	RST_BREATH | RST_INNATE)
...
RSF(BANSHEE_SCREAM,	RST_ANNOY | RST_INNATE)
RSF(SCARE,		RST_ANNOY)
RSF(BLIND,		RST_ANNOY)
RSF(CONF,		RST_ANNOY)
...
RSF(GROW_TREES, RST_ANNOY | RST_SUMMON | RST_INNATE)
RSF(POLYMORPH_WOLF, RST_TACTIC | RST_INNATE)
RSF(POLYMORPH_BAT,  RST_TACTIC | RST_INNATE)
RSF(POLYMORPH_MIST,  RST_ESCAPE | RST_INNATE)
RSF(MAX,		0)
