...
MON_TMD(STUN,			true,	MAX,	RF_NO_STUN,		50,		MON_MSG_DAZED,			MON_MSG_NOT_DAZED,		MON_MSG_MORE_DAZED)
...
MON_TMD(CHANGED,		false,	MAX,	0,				50,		0,						0,						0)
MON_TMD(POISONED,		true,	INCR,	RF_IM_POIS,		250,	MON_MSG_POISON,			0,						0)
MON_TMD(TOXIC,			true,	MAX,	RF_IM_POIS,		250,	MON_MSG_POISON,			0,						0)
MON_TMD(CHARMED,		true,	MAX,	0,				50,		0,						0,						0)
MON_TMD(SUFFOCATING,	true,	MAX,	RF_NONLIVING,	50,		MON_MSG_SUFFOCATE,		MON_MSG_NOT_SUFFOCATE,	0)
MON_TMD(SUMMONED,		false,	NO,		0,				50,		0,						0,						0)
